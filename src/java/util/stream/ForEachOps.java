...
final class ForEachOps {
    ...
    static final class ForEachTask<S, T> extends CountedCompleter<Void> {
        ...
        public void compute() {
            ...
            targetSize = sizeThreshold = 1;//TODO
...
//                /* ******************************************************************************/
//                Spliterator<S> leftSplit2;
//                if(( leftSplit2 = rightSplit.trySplit()) != null){
//                	ForEachTask<S, T> leftTask2 = new ForEachTask<>(task, leftSplit2);
//                    task.addToPendingCount(1);
//                    ForEachTask<S, T> taskToFork2=leftTask2;
//                    taskToFork2.fork();
//                }
//                forkRight = true;
//                if (forkRight) {
    ...
    static final class ForEachOrderedTask<S, T> extends CountedCompleter<Void> {
        ...
        private static <S, T> void doCompute(ForEachOrderedTask<S, T> task) {
            ...
            while (rightSplit.estimateSize() > sizeThreshold &&
                ...
                /* HaiTao
                 * Always submit the task wit current Spliterator into the queue,
                 * e.g. A blocking Spliterator. This approach can void all the worker
                 * threads block, in the case of there are multiple blocking Spliterators.
                 * */
//                forkRight=true;
//                System.out.println("ForEachOrderedTask blocking spliterator is submitted to the queue");
                if (forkRight) {
                    forkRight = false;
                    rightSplit = leftSplit;
                    task = leftChild;
